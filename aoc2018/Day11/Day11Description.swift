...
Actually, you're the one fading. The <span
title="wheeeeeeeeeeeeeeeeee">falling sensation</span> returns.
...
corner of *`33,45`* (with a total power of `29`); these fuel cells
appear in the middle of this 5x5 region:
